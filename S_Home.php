...
<html lang="en">
    ...
    <body>
        ...
        <section id="home">
            ...
            <!-- HEADER CONTENT -->
            <div class="header">
                <!-- FIX: display session name instead of static [Username] -->
...
<!-- NEW SECTION: WITH STUD -->
            <section id="about-student">
    <div class="content-box-left">
        <div class="community-text">
            <h3>Tulay Ugnayan</h3>
            <p>Every day, you walk past Q-Mart on your way to school—maybe you stop for a snack, grab some supplies, or simply pass through. But have you ever thought about how that shared space shapes your school life?</p>
            ...
            <p>Share your experience as a Ramonian student and help build better understanding between your school and the vendors. Your voice matters. Together, we can turn a shared neighborhood into a stronger community.</p>
        </div>
    </div>
</section>
        ...
        <!-- SURVEY BUTTON -->
        <section id="survey" style="background-image: url('https://i.imgur.com/YDbHZTe.jpeg');">
            <div class="button">
                <div class="community">
                    <img src="https://i.imgur.com/WWx2ogc.png" alt="Student Icon">
                    <h3>STUDENT SURVEY</h3>
                    <!-- FIX: changed .html to .php -->
                    <button type="button" onclick="window.location.href='StudentSurveyForm.php'">TAKE SURVEY</button>
                    <p>Share your experience as an RMCHS Student.</p>
                </div>
            </div>
        </section>
    ...
    <footer class="site-footer">
        ...
        <script>
            ...
            observer.observe(document.querySelector('.content-box-left'));
        </script>
    </body>
</html>